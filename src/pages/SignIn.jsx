      ...
      <div style={{ width: "100%", maxWidth: 420, animation: "fadeIn 0.4s ease" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          <div style={{
            ...
            <img src="/assets/jarvis.png" alt="Jarvis" style={{ width: 100, height: 100, borderRadius: "50%", objectFit: "cover" }} />
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <button
              ...
              style={{
                ...
                background: loading ? COLORS.redDim : COLORS.red,
        ...
        <p style={{ textAlign: "center", fontSize: 11, marginTop: 8, display: "flex", justifyContent: "center", gap: 16 }}>
          <a href="/terms"   style={{ color: COLORS.textDim, textDecoration: "none" }} onMouseEnter={(e) => e.target.style.color = COLORS.red} onMouseLeave={(e) => e.target.style.color = COLORS.textDim}>Terms of Service</a>
          <a href="/privacy" style={{ color: COLORS.textDim, textDecoration: "none" }} onMouseEnter={(e) => e.target.style.color = COLORS.red} onMouseLeave={(e) => e.target.style.color = COLORS.textDim}>Privacy Policy</a>
        </p>
      </div>
    </div>
  );
...
function MonkeyIcon({ size = 48 }) {
  const s = size;
  return (
    <svg width={s} height={s} viewBox="0 0 100 100" fill="none">
      <circle cx="50" cy="48" r="28" fill="none" stroke="#e01010" strokeWidth="3.5" />
      <circle cx="22" cy="50" r="9"  fill="none" stroke="#e01010" strokeWidth="3" />
      <circle cx="78" cy="50" r="9"  fill="none" stroke="#e01010" strokeWidth="3" />
      <circle cx="40" cy="44" r="4"  fill="#ff4040" />
      <circle cx="60" cy="44" r="4"  fill="#ff4040" />
      <ellipse cx="50" cy="58" rx="10" ry="7" fill="none" stroke="#e01010" strokeWidth="2.5" />
      <line x1="44" y1="58" x2="56" y2="58" stroke="#e01010" strokeWidth="2" />
    </svg>
  );
}
