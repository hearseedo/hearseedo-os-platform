// Global Ready — persistent Gemini memory
...
// profile keeps the exact legacy path (users/{uid}/globalReady/memory),
// unchanged; a real family-member profile gets its own doc under
// users/{uid}/familyMembers/{profileId}/globalReadyProfile/current.
const memoryRef = (uid, profileId) =>
  profileScopedDocRef(uid, profileId, "globalReady", "memory", "globalReadyProfile");
