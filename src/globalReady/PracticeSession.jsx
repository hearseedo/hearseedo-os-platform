...
// subtitle underneath so beginners can start before they're fluent. Each
// scenario roleplays a different character (homestay parent, immigration
// officer, classmate, etc.) rather than one fixed persona per category.
