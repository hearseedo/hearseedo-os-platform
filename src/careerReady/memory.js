// Career Ready — persistent Gemini memory
...
// profile keeps the exact legacy path (users/{uid}/careerReady/memory),
// unchanged; a real family-member profile gets its own doc under
// users/{uid}/familyMembers/{profileId}/careerReadyProfile/current.
const memoryRef = (uid, profileId) =>
  profileScopedDocRef(uid, profileId, "careerReady", "memory", "careerReadyProfile");
