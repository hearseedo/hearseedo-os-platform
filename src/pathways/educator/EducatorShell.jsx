...
export default function EducatorShell() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: EDU_COLORS.bg, color: EDU_COLORS.text, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      <header style={{ background: EDU_COLORS.card, borderBottom: `1px solid ${EDU_COLORS.border}`, padding: "14px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 10 }}>
