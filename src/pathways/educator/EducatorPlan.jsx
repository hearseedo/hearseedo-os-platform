      ...
      <div style={{ marginBottom: 32 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 16 }}>
          <Card>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 800, margin: "12px 0 4px" }}>{CONFIDENCE_FIRST_LESSONS.title}</h3>
            <p style={{ fontSize: 13, color: EDU_COLORS.textMuted }}>{CONFIDENCE_FIRST_LESSONS.subtitle}</p>
          </Card>
          <Card>
            <StatusBadge status="coming_soon" />
