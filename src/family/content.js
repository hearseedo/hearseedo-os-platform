...
export const HEAR_ACTIVITIES = [
  ...
  { activityId: "hear-talk-unlock-app", title: "Listen with Monkeys Unlock",  titleJp: "モンキーズ・アンロックで聞く", category: "hear", ageBands: ["elementary", "junior_high"], activityType: "iframe_app", duration: 10, skills: ["listening", "vocabulary"], media: { appId: "monkeys-unlock" }, curriculum: { source: "Monkeys Talk & Unlock" }, completionCriteria: "app_progress_event", icon: "🔓" },
...
export const SEE_ACTIVITIES = [
  ...
  { activityId: "see-talk-unlock-app",  title: "Explore Monkeys Unlock",      titleJp: "モンキーズ・アンロックを見る", category: "see", ageBands: ["elementary", "junior_high"], activityType: "iframe_app", duration: 10, skills: ["reading", "vocabulary", "problem_solving"], media: { appId: "monkeys-unlock" }, curriculum: { source: "Monkeys Talk & Unlock" }, completionCriteria: "app_progress_event", icon: "🗝️" },
...
export const DO_ACTIVITIES = [
  ...
  { activityId: "do-talk-unlock-app",   title: "Play & Unlock the Room",      titleJp: "モンキーズ・アンロックで遊ぼう", category: "do", ageBands: ["elementary", "junior_high"], activityType: "iframe_app", duration: 12, skills: ["speaking", "listening", "problem_solving"], media: { appId: "monkeys-unlock" }, curriculum: { source: "Monkeys Talk & Unlock" }, completionCriteria: "app_progress_event", icon: "🐵" },
