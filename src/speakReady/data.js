...
export const PICTURE_SCENES = [
  { id: "train_station", image: "/assets/picture-scenes/train_station.svg", persona: "an encouraging conversation partner asking you to describe and discuss a scene", prompt: "A busy morning at a train station — commuters rushing while a food cart owner prepares breakfast.", promptJp: "駅の忙しい朝 — 急ぐ通勤客と朝食を準備する屋台のオーナー。" },
  { id: "birthday",      image: "/assets/picture-scenes/birthday.svg",      persona: "an encouraging conversation partner asking you to describe and discuss a scene", prompt: "A birthday party in a backyard, with balloons, a cake, and kids playing games.",                    promptJp: "庭でのお誕生日会 — 風船とケーキ、遊んでいる子どもたち。" },
  { id: "kitchen",       image: "/assets/picture-scenes/kitchen.svg",       persona: "an encouraging conversation partner asking you to describe and discuss a scene", prompt: "A busy restaurant kitchen during the dinner rush, chefs moving quickly between stations.",           promptJp: "夕食時で忙しいレストランの厨房 — 素早く動くシェフたち。" },
  { id: "rainy_city",    image: "/assets/picture-scenes/rainy_city.svg",    persona: "an encouraging conversation partner asking you to describe and discuss a scene", prompt: "A rainy day in the city, people with umbrellas crossing a busy street.",                             promptJp: "雨の日の街 — 傘をさして交差点を渡る人々。" },
  { id: "hiking",        image: "/assets/picture-scenes/hiking.svg",        persona: "an encouraging conversation partner asking you to describe and discuss a scene", prompt: "A group of friends hiking up a mountain trail with a view of the valley below.",                     promptJp: "山道をハイキングする友人グループと谷の景色。" },
  { id: "market",        image: "/assets/picture-scenes/market.svg",        persona: "an encouraging conversation partner asking you to describe and discuss a scene", prompt: "A colorful farmers market with fresh fruit, vegetables, and vendors calling out prices.",            promptJp: "色とりどりのファーマーズマーケット — 新鮮な野菜と呼び込みの声。" },
  { id: "moving",        image: "/assets/picture-scenes/moving.svg",        persona: "an encouraging conversation partner asking you to describe and discuss a scene", prompt: "Moving into a new apartment, boxes everywhere and furniture half-assembled.",                        promptJp: "新しいアパートへの引っ越し — 段ボールと組み立て途中の家具。" },
  { id: "beach",         image: "/assets/picture-scenes/beach.svg",         persona: "an encouraging conversation partner asking you to describe and discuss a scene", prompt: "A beach vacation, people swimming, reading, and playing volleyball in the sun.",                     promptJp: "ビーチでのバケーション — 泳いだり読書したりバレーボールをする人々。" },
];
