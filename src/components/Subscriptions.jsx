  ...
  return (
    <div style={{ animation: "fadeIn 0.3s ease" }}>
      ...
      <div style={{
        ...
        <img src="/assets/jarvis.png" alt="Jarvis" style={{ width: 56, height: 56, borderRadius: "50%", objectFit: "cover", filter: "drop-shadow(0 0 10px rgba(224,16,16,0.5))", flexShrink: 0 }} />
